...
public class BoardDataDrawer : Editor
{
    ...
    {
        InitialReordableList(ref _dataList, "SearchWords", "Searching Words");
    }
    ...
    private void InitialReordableList(ref ReorderableList list, string propertyName, string listLabel)
    {
        ...
        var l = list;
        list.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocusted) =>
        {
